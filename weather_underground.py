...
if len(sys.argv) != 2:
    print "\nUsage:"
    print "%s [ mx | tx | mi | rnc | wnc | fl | way | cc | rb | nyc | ca ]" % sys.argv[0]
    print "\n"
    sys.exit(1)
elif len(sys.argv) == 2:
    station = sys.argv[1]
    ...
    if station == 'tx':
        ...
        url_forecast = urlbase + 'geolookup/conditions/forecast/q/zmw:02540.1.99999.json'
        url_sunrise  = urlbase + 'astronomy/q/zmw:02540.1.99999.json'
    elif station == 'rb':
